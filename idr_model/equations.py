"""
equations.py — дискретизация системы уравнений методом конечных
разностей на равномерной сетке r_i = i·h, i = 0 .. N.

Система уравнений
─────────────────
(1/r) d/dr [ r · (σ_a/|σ|²) · d|H|²/dr ] = 2·σ_a·|E|²

(1/r²) d/dr [ r² · (σ_a/|σ|²) · d|E|²/dr ] = 2·σ_a·|H|²/r²·...

Da·(d²σ/dr² + (1/r)·dσ/dr) + νi·σ = 0
...
def build_H_equation(r: np.ndarray, h: float,
    ...
    """
    Строит трёхдиагональную СЛАУ для уравнений:
    ...
    for i in range(1, N):
        ...
        coef = 1.0 / (ri * h**2)
        # L[u] = 2σ_a·v, L = (1/r)d/dr[r·α·d/dr]
