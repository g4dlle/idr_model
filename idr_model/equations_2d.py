"""
equations_2d.py — дискретизация системы уравнений (11)–(13) на 2D
...
Уравнения
─────────
(11)  (1/r)∂/∂r(r·α·∂u/∂r) + ∂/∂z(α·∂u/∂z) = 2σ_a·v

(13)  (1/r)∂/∂r(r·Da·∂σ/∂r) + ∂/∂z(Da·∂σ/∂z) + νi·σ = 0
...
def build_H_equation_2d(r, z, hr, hz,
                        ...
                        bc_z="neumann"):
    """
    Собирает разреженную СЛАУ для уравнения (11) на 2D-сетке.
...
def build_sigma_equation_2d(r, z, hr, hz,
    ...
    """
    Собирает разреженную СЛАУ для уравнения (13) на 2D-сетке.
